    ...
    <footer className="bg-gray-900 text-gray-400 pt-16 pb-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <h2 className="text-white text-2xl font-bold mb-3">
              Chondik<span className="text-blue-500">.</span>
            </h2>
            <p className="text-sm leading-relaxed mb-5">
              Platform konten berkualitas tinggi untuk pembaca yang haus akan inspirasi dan pengetahuan.
            </p>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-sm">
          <p>© {new Date().getFullYear()} Chondik. Hak cipta dilindungi.</p>
          <p>Dibuat dengan ❤️ menggunakan Next.js + WordPress</p>
        </div>
      </div>
    </footer>
  )
